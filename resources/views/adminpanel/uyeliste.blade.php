  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <form class="form-inline my-2 my-lg-0" type="get" action="{{route('searchuser')}}">
          <input class="form-control mr-sm-2" name= "query" type="search" placeholder="Üye Ara"></input>
          <button class="btn btn-outline-light my-2 my-sm-0" type= "submit">Üye Ara</button>
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="card-title mb-3">Üyeler</h4>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped table-borderless" style="table-layout: fixed;">
                                ...
                                <tbody>
                                    ...
                                    <tr data-user-id="{{$user->id}}" class="order-detail-link">
            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-center">
                    {{ $registeredUsers->links('vendor.pagination.bootstrap-4') }}
                </div>
            </div>
        </div>
      </div>
