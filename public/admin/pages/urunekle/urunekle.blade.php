    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/urunekle/urunekle.html">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/tables/basic-table.html">
              <i class="icon-paper menu-icon"></i>
              <span class="menu-title">Ürün Düzenle</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/documentation/documentation.html">
              <i class="icon-paper menu-icon"></i>
              <span class="menu-title">Ürün Sil</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/documentation/documentation.html">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="{{route('urunekleme')}}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="exampleInputCity1">Slug</label>
                        <input type="text" class="form-control" name="slug" placeholder="Slug">
                      </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Kategori</label>
                      <input type="text" class="form-control" name="categories" placeholder="Kategori">
                    </div>
                    <div class="form-group">
